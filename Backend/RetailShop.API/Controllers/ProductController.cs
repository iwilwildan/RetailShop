...
namespace RetailShop.API.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpPost("addItem")]
        public async Task<IActionResult> AddItem([FromBody] ProductDto productDto)
        {
            try
            {
                ...
                {
                    var productCategory = await _productRepository.GetCategory(newProduct.CategoryId);
                    var result = newProduct.ConvertToDto(productCategory);
                    return Ok(result);
                }
            }
            catch (Exception ex)
